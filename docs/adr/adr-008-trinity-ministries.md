...
**Entrypoint:** `runbooks/ministry-secrets/deploy.sh`  
...
**Entrypoint:** `runbooks/ministry-whispers/harden.sh`  
...
**Entrypoint:** `runbooks/ministry-perimeter/apply.sh`  
...
- ✅ Phase 1 runbook: `runbooks/ministry-secrets/deploy.sh` (212 lines)
- ✅ Phase 2 runbook: `runbooks/ministry-whispers/harden.sh` (279 lines)
- ✅ Phase 3 runbook: `runbooks/ministry-perimeter/apply.sh` (343 lines)
...
- ✅ Repo bloat pruned: PowerShell scripts, PXE artifacts removed (≤150 files)
