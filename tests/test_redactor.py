...
class TestRedactorPatterns:
    ...
    def test_redact_serial_number(self):
...
class TestRedactorMethods:
    ...
    def test_method_auto_uses_regex_when_presidio_unavailable(self):
    ...
    def test_method_regex_explicit(self):
        """Explicit regex method works."""
        text = "Email: user@example.com"
        result = redact_pii(text, method="regex")
        assert "[REDACTED]" in result

    def test_method_presidio_graceful_fallback(self):
