...
class TestUniFiClientInit:
    ...
    def test_client_init_trailing_slash_removed(self) -> None:
        """Client strips trailing slashes from base_url."""
        client = UniFiClient("https://controller.local/")
        assert client.base_url == "https://controller.local"

    def test_client_init_ssl_verification_disabled(self) -> None:
...
class TestUniFiClientRequests:
    ...
    def test_get_request(self, mock_session_func: Any) -> None:
    ...
    @patch("shared.unifi_client.get_authenticated_session")
    def test_post_request(self, mock_session_func: Any) -> None:
    ...
    @patch("shared.unifi_client.get_authenticated_session")
    def test_put_request(self, mock_session_func: Any) -> None:
...
class TestUniFiClientNetworkMethods:
    ...
    @patch("shared.unifi_client.get_authenticated_session")
    def test_list_networks(self, mock_session_func: Any) -> None:
    ...
    @patch("shared.unifi_client.get_authenticated_session")
    def test_create_network(self, mock_session_func: Any) -> None:
...
class TestUniFiClientErrorHandling:
    ...
    @patch("shared.unifi_client.get_authenticated_session")
    def test_request_http_error(self, mock_session_func: Any) -> None:
    ...
    @patch("shared.unifi_client.get_authenticated_session")
    def test_request_empty_data_response(self, mock_session_func: Any) -> None:
    ...
    @patch("shared.unifi_client.get_authenticated_session")
    def test_endpoint_url_construction(self, mock_session_func: Any) -> None:
    ...
    @patch("shared.unifi_client.get_authenticated_session")
    def test_verify_ssl_respected_in_requests(self, mock_session_func: Any) -> None:
